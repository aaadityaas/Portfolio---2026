...
import GrassFooter from "../imports/GrassFooter/GrassFooter";
    ...
    >
      <style>{`
        ...
        *, *::before, *::after {
        ...
        [data-name="grass-footer"] div[data-name^="grass"],
        [data-name="grass-footer"] div[data-name="17"],
        [data-name="grass-footer"] div[data-name="18"],
        [data-name="grass-footer"] div[data-name="16"],
        [data-name="grass-footer"] div[data-name="14"],
        [data-name="grass-footer"] div[data-name="13"],
        [data-name="grass-footer"] div[data-name="12"],
        [data-name="grass-footer"] div[data-name="11"],
        [data-name="grass-footer"] div[data-name="10"] {
          transform-origin: bottom center;
          animation: windFlow 2.5s ease-in-out infinite;
          will-change: transform;
        }

        [data-paused="true"] [data-name="grass-footer"] *,
        [data-paused="true"] [data-name="robot"] {
          animation-play-state: paused !important;
        }

        [data-name="grass-footer"] div[data-name="grass dark"] { animation-delay: 0.1s; animation-duration: 2.7s; }
        [data-name="grass-footer"] div[data-name="grass light"] { animation-delay: 0.4s; animation-duration: 2.2s; }
        [data-name="grass-footer"] div[data-name="17"] { animation-delay: 0.2s; }
        [data-name="grass-footer"] div[data-name="18"] { animation-delay: 0.7s; }
        [data-name="grass-footer"] div[data-name="16"] { animation-delay: 0.5s; animation-duration: 3s; }
        [data-name="grass-footer"] div[data-name="14"] { animation-delay: 0.3s; }
        [data-name="grass-footer"] div[data-name="13"] { animation-delay: 0.6s; }
